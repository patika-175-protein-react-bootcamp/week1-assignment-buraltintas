...
koreaBtn.addEventListener("click", () => {
  const filteredItems = menu.filter((item) => item.category === "Korea");
  container.innerHTML = "";
...
japanBtn.addEventListener("click", () => {
  const filteredItems = menu.filter((item) => item.category === "Japan");
  container.innerHTML = "";
...
chinaBtn.addEventListener("click", () => {
  const filteredItems = menu.filter((item) => item.category === "China");
  container.innerHTML = "";
